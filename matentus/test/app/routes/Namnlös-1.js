...
passport.use(new FacebookStrategy({
  ...
  .then(function(user) {
    if (!user) {
     var userX = models.User.create({ username: profile.displayName, email: profile._json.email, password: null , fbid: profile.id}).then(function(err, userX){return cb(err,userX)});
